...
namespace LyraGameplayTags
{
	...
	LYRAGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(CustomMovement_Mode_WallRunLeft);
	LYRAGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(CustomMovement_Mode_WallRunRight);
